...
const notice_api = `${import.meta.env.VITE_API_URL}/${
...
axios
  .get(notice_api, { withCredentials: true })
  .then((response: AxiosResponse<NoticeInfo>) => {
...
const handleDelete = (index: number, row: TableColumnCtx<string>) => {
